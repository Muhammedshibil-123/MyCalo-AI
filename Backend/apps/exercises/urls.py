...
urlpatterns = [
    ...
    path("admin/manage/<int:pk>/", AdminExerciseDetailView.as_view(), name="admin-exercise-detail"),
    path("admin/manage/<int:pk>/verify/", AdminExerciseVerifyView.as_view(), name="admin-exercise-verify"),
]
