...
class FoodItem(models.Model):
    ...
    carbohydrates = models.DecimalField(
        max_digits=6, decimal_places=2, help_text="Carbs in grams"
    )
    fat = models.DecimalField(max_digits=6, decimal_places=2, help_text="Fat in grams")
    fiber = models.DecimalField(
        max_digits=6, decimal_places=2, default=0.00, help_text="Fiber in grams"
    )

    # Key Health Signals
    sugar = models.DecimalField(
        max_digits=6, decimal_places=2, default=0.00, help_text="Sugar in grams"
    )
    saturated_fat = models.DecimalField(
        max_digits=6, decimal_places=2, default=0.00, help_text="Saturated fat in grams"
    )
    sodium = models.DecimalField(
        max_digits=8, decimal_places=2, default=0.00, help_text="Sodium in mg"
    )
    cholesterol = models.DecimalField(
        max_digits=8, decimal_places=2, default=0.00, help_text="Cholesterol in mg"
    )
