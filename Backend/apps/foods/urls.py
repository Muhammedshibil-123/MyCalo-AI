...
urlpatterns = [
    ...
    path(
        "admin/manage/<int:pk>/",
        AdminFoodDetailView.as_view(),
        name="admin-food-detail",
    ),
    path(
        "admin/manage/<int:pk>/verify/",
        AdminFoodVerifyView.as_view(),
        name="admin-food-verify",
    ),
    path(
        "admin/manage/images/<int:pk>/",
        AdminFoodImageDeleteView.as_view(),
        name="admin-food-image-delete",
    ),
]
