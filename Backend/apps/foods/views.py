...
from .models import FoodItem, FoodVote,FoodImage
from .serializers import FoodItemSerializer, VoteSerializer,AdminFoodItemSerializer
...
class AdminFoodListView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            source_type = "ADMIN" if request.user.role in ['admin', 'employee'] else "DOCTOR"
