...
class UsersCountView(APIView):
    ...
    def get(self, request):
        ...
        return Response(
            {"total": total_users, "doctors": doctors, "employees": employees}
        )
...
class FoodSourceDistributionView(APIView):
    ...
    def get(self, request):
        ...
        data = [
            {"source": item["source"], "count": item["count"]} for item in distribution
        ]
...
class TopFoodsView(APIView):
    ...
    def get(self, request):
        ...
        top_foods = (
            DailyLog.objects.values(
                "food_item__id",
                "food_item__name",
                "food_item__calories",
                "food_item__source",
            )
            .annotate(consumption_count=Count("id"))
...
class UserManagementListView(APIView):
    ...
    def get(self, request):
        ...
        if role_param == "deleted":
            users = (
                CustomUser.objects.filter(status="inactive")
                .values(
                    "id",
                    "username",
                    "email",
            ...
            users = (
                CustomUser.objects.filter(role=role_param, status="active")
                .values(
                    "id",
                    "username",
                    "email",
