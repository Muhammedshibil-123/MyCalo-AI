...
urlpatterns = [
    ...
    path(
        "exercise-logs/<int:pk>/",
        ExerciseLogDetailView.as_view(),
        name="exercise-log-detail",
    ),
    path(
        "patient-logs/<int:user_id>/",
        PatientDailyLogView.as_view(),
        name="patient-logs",
    ),
    path(
        "patient-exercise-logs/<int:user_id>/",
        PatientExerciseLogView.as_view(),
        name="patient-exercise-logs",
    ),
]
