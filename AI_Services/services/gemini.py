...
class GeminiService:
    ...
    async def analyze_food(self, food_query: str) -> dict:
        ...
        2. Estimate the serving size in GRAMS (integer) based on the user's text.
        3. Calculate nutrition for 100 GRAMS of the food item.
        4. Provide an 'overall_suggestion': A 4-line summary offering health advice.

        OUTPUT FORMAT (Strict JSON, No Markdown):
        {{
          "overall_suggestion": "Your 3 lines of advice here...",
          "items": [
            {{
        ...
        IMPORTANT:
        - serving_size_g must be an INTEGER.
        - Nutrition values must be FLOATS per 100g (not lists).
        """
        ...
        print("[FATAL] All failover models failed.")
